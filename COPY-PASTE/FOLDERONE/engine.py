...
class entity(object):
    ...
    def __init__(self,x,y,size_x,size_y,e_type,flip): # x, y, size_x, size_y, type
        self.x = x
        self.y = y
        self.size_x = size_x
        self.size_y = size_y
    ...
    def set_canJumpAgain(self,boolean):
        self.canJumpAgain = boolean
